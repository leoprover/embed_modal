...
public class TestQmltp {
    ...
    public static void main(String[] args) {
        ...
        String directoryPath = args[0]; // /home/tg/university/bachelor_thesis/software/output/convert_qmltp
        ...
        try { // open meta file try block
            ...
            Files.write(Paths.get(resultPath + "_average_time_per_meta_index_plot_script.py"),script1.getBytes());
            ...
            Files.write(Paths.get(resultPath + "_average_time_per_category.txt"), categoryLatex.getBytes());

            // save average parsing time to as plaintext
            String averageParsingTime = String.valueOf(generalResult.getAverageTime());
            Files.write(Paths.get(resultPath + "_average_time.txt"), averageParsingTime.getBytes());
